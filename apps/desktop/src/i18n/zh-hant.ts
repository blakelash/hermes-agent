...
export const zhHant = defineLocale({
  ...
  sidebar: {
    ...
    unassigned: '未指派',
    newProject: '新增專案',
    newProjectDesc: '專案將相關工作階段歸為一組，並提供共享的持久工作目錄。',
    newProjectPlaceholder: '專案名稱…',
    newProjectCreated: name => `已建立專案 ${name}`,
    newProjectFailed: '無法建立專案',
    ...
    row: {
      ...
      moveToProject: '移至專案',
      moveToProjectDesc: '將此工作階段歸入某個專案。對於訊息平台聊天，該聊天的後續工作階段也會在此專案中開始。',
      moveToProjectNone: '無專案',
      moveToProjectFailed: '無法移動工作階段',
      movedToProject: name => `已移至 ${name}`,
      removedFromProject: '已從專案移除',
