...
export const zh: Translations = {
  ...
  sidebar: {
    ...
    unassigned: '未分配',
    newProject: '新建项目',
    newProjectDesc: '项目将相关会话归为一组，并提供共享的持久工作目录。',
    newProjectPlaceholder: '项目名称…',
    newProjectCreated: name => `已创建项目 ${name}`,
    newProjectFailed: '无法创建项目',
    ...
    row: {
      ...
      moveToProject: '移动到项目',
      moveToProjectDesc: '将此会话归入某个项目。对于消息平台聊天，该聊天的后续会话也会在此项目中开始。',
      moveToProjectNone: '无项目',
      moveToProjectFailed: '无法移动会话',
      movedToProject: name => `已移动到 ${name}`,
      removedFromProject: '已从项目中移除',
