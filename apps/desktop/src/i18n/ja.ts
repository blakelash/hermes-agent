...
export const ja = defineLocale({
  ...
  sidebar: {
    ...
    groupAriaUngrouped: 'プロジェクトごとにセッションをグループ化',
    ...
    unassigned: '未割り当て',
    newProject: '新規プロジェクト',
    newProjectDesc: 'プロジェクトは関連するセッションをまとめ、共有の永続的な作業ディレクトリを提供します。',
    newProjectPlaceholder: 'プロジェクト名…',
    newProjectCreated: name => `プロジェクト ${name} を作成しました`,
    newProjectFailed: 'プロジェクトを作成できませんでした',
